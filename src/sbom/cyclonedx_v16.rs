...
impl CycloneDxSbomV1_6 {
    pub fn from_raw(raw_sbom: &RawSbom) -> CycloneDxSbomV1_6 {
        ...
        for (index, component) in raw_sbom.components.iter().enumerate() {
            let mut cdx_component = CycloneDxComponentV1_6::from_raw(component);
            ...
            if index == raw_sbom.bom_metadata.root_component_index {
                ...
                cdx_component.component_type = CycloneDxComponentTypeV1_6::application;
...
struct CycloneDxMetadataV1_6 {
    ...
    component: Option<CycloneDxComponentV1_6>,
...
impl From<String> for CycloneDxLicenseExpressionV1_6 {
    fn from(value: String) -> Self {
        CycloneDxLicenseExpressionV1_6 {
            expression: value,
...
impl CycloneDxExternalReferenceV1_6 {
    fn generate_tool_component_reference() -> CycloneDxExternalReferenceV1_6 {
        CycloneDxExternalReferenceV1_6 {
            ...
            comment: None,
            reference_type: CycloneDxExternalReferenceTypeV1_6::vcs,
            hashes: None,
        }
    }
    ...
    fn from_raw_component(raw_component: &RawComponent) -> Vec<CycloneDxExternalReferenceV1_6> {
        ...
        if let Some(vcs) = raw_component.vcs.clone() {
            references_vector.push(CycloneDxExternalReferenceV1_6::from_uri_source_code(vcs));
        }
